SELECT
    ...
    CAST(IF(posicao_id = 6, FALSE, COALESCE(entrou_em_campo, pontuacao != 0)) AS booelan) AS played
    ...
    CAST(COALESCE(pe, pi, 0) AS missed_pass,
    CAST(COALESCE(rb, ds, 0) AS tackle,
